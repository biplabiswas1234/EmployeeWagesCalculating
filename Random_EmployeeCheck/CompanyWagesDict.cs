...
{
    internal class CompanyWageDict
    {
        ...
        public CompanyWageDict(string CompanyName, int EmpWagePerHr, int FullTimeWorkHrsPerDay, int PartTimeWorkHrsDay, int MaxWorkHrs, int MaxWorkDays)
        {
    ...
    class EmpWageComputation
    {
        ...
        public Dictionary<string, CompanyWageDict> Companies = new Dictionary<string, CompanyWageDict>();
        ...
        {
            CompanyWageDict company = new CompanyWageDict(CompanyName.ToLower(), EmpWagePerHr, FullTimeWorkHrsPerDay, PartTimeWorkHrsDay, MaxWorkHrs, MaxWorkDays);
        ...
        public void CalcEmpWage(string CompanyName)
        {
            ...
            Companies.TryGetValue(CompanyName.ToLower(), out CompanyWageDict company);
