...
{
    internal class MultipleCompanyInterface
    {
        ...
        public MultipleCompanyInterface(string CompanyName, int WagePerHr, int FullHrPerDay, int PartHrPerDay, int MaxWorkHrs, int MaxWorkDays)
        {
    ...
    class Wage_Computation : ICompanyEmpWage
    {
        ...
        public Dictionary<string, MultipleCompanyInterface> Companies_Dict;
        public string[] Company_List;
        public int Company_Index = 0;

        public Wage_Computation(int Number)
        {
            Companies_Dict = new Dictionary<string, MultipleCompanyInterface>();
        ...
        public void AddCompany(string CompanyName, int WagePerHr, int FullHrPerDay, int PartHrPerDay, int MaxWorkHrs, int MaxWorkDays)
        {
            MultipleCompanyInterface company = new MultipleCompanyInterface(CompanyName.ToLower(), WagePerHr, FullHrPerDay, PartHrPerDay, MaxWorkHrs, MaxWorkDays);
        ...
        public void WageCalculation(string CompanyName)
        {
            ...
            Companies_Dict.TryGetValue(CompanyName.ToLower(), out MultipleCompanyInterface company);
            ...
            Company_Index++;
            Console.WriteLine("\nThe Name of the Company : " + CompanyName);
            Console.WriteLine("Total Working Days:" + PresentDays + "  " + "Total Working Hours :" + TotalWorkHrs + " " + "Total Employee Wage :" + MontlyWage);
        }
