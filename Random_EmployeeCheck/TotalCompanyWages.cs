...
{
    internal class TotalCompanyWage
    {
        ...
        public TotalCompanyWage(string CompanyName, int EmpWagePerHr, int FullTimeWorkHrsPerDay, int PartTimeWorkHrsDay, int MaxWorkHrs, int MaxWorkDays)
        {
    ...
    class CompanyWage_Computation
    {
        ...
        public Dictionary<string, TotalCompanyWage> Companies = new Dictionary<string, TotalCompanyWage>();
        ...
        {
            TotalCompanyWage comp = new TotalCompanyWage(CompanyName.ToLower(), EmpWagePerHr, FullTimeWorkHrsPerDay, PartTimeWorkHrsDay, MaxWorkHrs, MaxWorkDays);
        ...
        public void Calc_CompanyWage(string CompanyName)
        {
            ...
            Companies.TryGetValue(CompanyName.ToLower(), out TotalCompanyWage comp);
